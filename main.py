...
def plot_experiment(nb_losses,svm_losses,xaxis_var,xlabel,cv_split_number,fn=None):
    model_losses = {"nb":[nb_losses,"b--"],"svm: c = 0.25":[svm_losses,"o--"],"svm: c = 0.50":[svm_losses,"r--"],"svm: c = 0.75":[svm_losses,"k--"],"svm: c = 1.0":[svm_losses,"y--"]}
    model_lines = {}
...
if __name__ == "__main__":
    ...
    if False:
        ...
        if exp_no == "1" or exp_no == "-1":
            nb_losses,svm_losses,svm_c1_losses,svm_c2_losses,svm_c3_losses,xaxis_var,xlabel =\
                   experiment_1(tr_data,tr_labels,cv_split_number)
            plot_experiment(nb_losses,svm_losses,\
